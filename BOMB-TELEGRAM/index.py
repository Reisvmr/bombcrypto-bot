...
cat = """
                                               ...
                                               `*-*   `*-*  `*-*'
=========================================================================
========== 💰 Eu te ajudei de alguma forma? Só peço uma dica! 🧾 ======
...
def addRandomness(n, randomn_factor_size=None):
    """Retorna n com aleatoriedade
    Parâmetros:
        n (int): A decimal integer
        randomn_factor_size (int):O valor máximo+- de aleatoriedade que será
            Adicionado a n

   Devoluções:
        int: n com aleatoriedade
    """
...
def remove_suffix(input_string, suffix):
    """Retorna o input_string sem o sufixo"""
...
def load_images(dir_path='./targets/'):
    """ Carrega programaticamente todas as imagens de dir_path como key:value onde o
        key é o nome do arquivo sem o sufixo.png

    Devoluções:
        dict: dicionário contendo as imagens carregadas como pares chave:valor.
    """
...
def loadHeroesToSendHome():
    """Carrega as imagens no caminho e as salva como uma lista"""
...
def show(rectangles, img = None):
    """ Mostre um pop-up com retângulos mostrando os retângulos[(x, y, w, h),...]
        sobre img ou printSreen se nenhuma img for fornecida. Útil para depuração"""
...
def clickBtn(img, timeout=3, threshold = ct['default']):
    """
    ##PT-BR##
    "Procure por img no scree, se encontrado move o cursor sobre ele e clica.
    Parâmetros:
        img: A imagem que será usada como modelo para encontrar onde clicar.
        timeout (int): Tempo em segundos que ele continuará procurando a img antes de retornar com falha
        threshold(float): Quão confiante o bot precisa estar para clicar nos botões (valores de 0 a 1)
    #########################################################################
...
def isHome(hero, buttons):
    ...
    for (_,button_y,_,button_h) in buttons:
        ...
        if isBelow and isAbove:
            # se o botão enviar para casa existir, o herói não está em casa
            return False
    return True
